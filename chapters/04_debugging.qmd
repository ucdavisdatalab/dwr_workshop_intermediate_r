...
[here](https://raw.githubusercontent.com/ucdavisdatalab/workshop_intermediate_r/main/R/debug_case_study.R) to a new blank script on our computer(s). The script provides a function that splits the penguins into groups according to some grouping factors like species and sex, then plots the uncertainty in the average penguin mass per group. The plot is shown below for mass by species.
