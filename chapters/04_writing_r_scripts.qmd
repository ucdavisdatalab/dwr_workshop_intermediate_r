...
This chapter is organized around case studies (@sec-case-study-bart-ridership,
...
:::{important}
Each time we teach this case study, the result is slightly different. Here are
some of the scripts from past workshops:

* [2025-02-05](https://github.com/ucdavisdatalab/workshop_intermediate_r/blob/main/R/2025-02-06_clean-bart.R)
:::
...
processing and stringr in general, see @sec-string-date-processing.
...
to know more about how to fix "messy data" problems, read
@sec-string-date-processing.
...
## Managing Environments {#sec-managing-environments}
...
## Iteration Strategies {#sec-iteration-strategies}
...
about this in @section-break-next). As with if-statements and functions, the
curly braces `{ }` are only required if the body contains multiple lines of
...
## Printing Output {#sec-printing-output}

This section introduces several different functions for printing output and
making that output easier to read.
