...
## Parsing Dates & Times {#sec-parsing-dates-times}
...
strings. The next section, @sec-the-stringr-package, describes the stringr
package for working with strings. The last section, @sec-regular-expressions,
builds on both and explains how to do powerful pattern matching.
...
You can learn more about different ways to print output in R by reading
@sec-printing-output.
...
Raw strings (see @sec-raw-strings) make regular expressions easier to read,
